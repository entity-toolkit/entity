...
for ti in range(0, tvals, 10):
    ax1.plot(
        data.spectra.E.values / data.attrs["setup.temperature"],
        data.spectra.N_3.isel(t=ti).values,
        c=plt.get_cmap("plasma")(ti / tvals),
        lw=0.5,
    )
...
ax2.plot(stats["time"], stats["T00_3"], c="C0")
ax2.set(ylabel=r"total photon energy", xlabel=r"$t$")
ax2.yaxis.label.set_color("C0")
ax2.tick_params(axis="y", labelcolor="C0")
ax2twin = ax2.twinx()
ax2twin.plot(data.spectra.t.values, data.spectra.N_3.sum("E"), c="C2")
