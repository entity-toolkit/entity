...
namespace timer {
  ...
  static const TimeUnit second(1, "s");
  static const TimeUnit millisecond(1e-3, "ms");
  static const TimeUnit microsecond(1e-6, "us");
  static const TimeUnit nanosecond(1e-9, "ns");
