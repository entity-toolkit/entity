...

    {
      ...
      Kokkos::parallel_reduce(
        ...
        Lambda(ntt::index_t i1, ntt::index_t i2, std::size_t & correct_cnt_l) {
          ...
          const auto all_correct = h11isCorrect && h22isCorrect &&
                                   h33isCorrect && h13isCorrect &&
                                   h_11isCorrect && h_22isCorrect &&
                                   h_33isCorrect && h_13isCorrect;
      ...
      if (correct_cnt != nx1 * nx2) {
        throw std::logic_error(
          ...
          std::to_string(nx1 * nx2) + " are correct.");
      }
    }
