...
namespace ntt {
  ...
  Inline void surfaceRotationField(const coord_t<D>& x_ph,
    ...
    // _omega *= -0.5*math::tanh(50.*(-0.7853981633974483 + x_ph[1]))*(-1. + math::tanh(50.*(-0.9599310885968813 + x_ph[1]))*math::tanh(50.*(-0.6108652381980153 + x_ph[1])));
    // _omega *= -0.5*math::tanh(25.*(-0.6108652381980153 + x_ph[1]))*(-1. + math::tanh(25.*(-0.7853981633974483 + x_ph[1]))*math::tanh(25.*(-0.4363323129985824 + x_ph[1])));
