...
struct NTTSimulationVis : public nttiny::SimulationAPI<float> {
  ...
  void generateGrid() {
    ...
    if (this->coords == "qspherical") {
      ...
      // m_x1x2_extent[0] = -ntt::N_GHOSTS;
      // m_x1x2_extent[1] = nx1 - ntt::N_GHOSTS;
      // m_x1x2_extent[2] = -ntt::N_GHOSTS;
      // m_x1x2_extent[3] = nx2 - ntt::N_GHOSTS;
      // // !HACK: temporary
