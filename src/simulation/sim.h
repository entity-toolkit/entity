...
namespace ntt {
  ...
  public:
    ...
    auto get_precision() const -> std::size_t { return sizeof(real_t); }
    auto get_dimension() const -> Dimension { return m_dimension; }
    auto get_coord_system() const -> CoordinateSystem { return m_coord_system; }
