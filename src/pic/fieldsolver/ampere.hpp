...
Inline void Ampere<ONE_D>::operator()(const index_t i) const {
  ...
  real_t inv_sqrt_detH_i {ONE / m_mblock.m_coord_system->sqrt_det_h(x1)};
  real_t h2_iP {m_mblock.m_coord_system->hx2(x1 + 0.5 * dx1)};
  real_t h2_iM {m_mblock.m_coord_system->hx2(x1 - 0.5 * dx1)};
  real_t h3_iP {m_mblock.m_coord_system->hx3(x1 + 0.5 * dx1)};
  real_t h3_iM {m_mblock.m_coord_system->hx3(x1 - 0.5 * dx1)};
...
Inline void Ampere<TWO_D>::operator()(const index_t i, const index_t j) const {
  ...
  real_t inv_sqrt_detH_ij {ONE / m_mblock.m_coord_system->sqrt_det_h(x1, x2)};
  ...
  real_t h1_ijM {m_mblock.m_coord_system->hx1(x1, x2 - 0.5 * dx2)};
  real_t h1_ijP {m_mblock.m_coord_system->hx1(x1, x2 + 0.5 * dx2)};
  real_t h2_iPj {m_mblock.m_coord_system->hx2(x1 + 0.5 * dx1, x2)};
  real_t h2_iMj {m_mblock.m_coord_system->hx2(x1 - 0.5 * dx1, x2)};
  real_t h3_iMjP {m_mblock.m_coord_system->hx3(x1 - 0.5 * dx1, x2 + 0.5 * dx2)};
