...
namespace ntt {
  ...
  Inline void AmpereMinkowski<Dimension::ONE_D>::operator()(const index_t i) const {
    m_mblock.em(i, em::ex2) += m_coeff * (m_mblock.em(i - 1, em::bx3) - m_mblock.em(i, em::bx3));
    m_mblock.em(i, em::ex3) += m_coeff * (m_mblock.em(i, em::bx2) - m_mblock.em(i - 1, em::bx2));
  }

  template <>
  Inline void AmpereMinkowski<Dimension::TWO_D>::operator()(const index_t i, const index_t j) const {
    m_mblock.em(i, j, em::ex1) += m_coeff * (m_mblock.em(i, j, em::bx3) - m_mblock.em(i, j - 1, em::bx3));
    m_mblock.em(i, j, em::ex2) += m_coeff * (m_mblock.em(i - 1, j, em::bx3) - m_mblock.em(i, j, em::bx3));
