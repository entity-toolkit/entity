...
namespace ntt {
  ...
  public:
     ...
     * @param v particle current 3-velocity.
     */
    Inline void coordinateUpdate(const index_t&, const vec_t<Dimension::THREE_D>&) const;
     ...
     * @param v corresponding 3-velocity component.
     */
    Inline void coordinateUpdate_x123(const index_t&, const real_t&, const real_t&, const real_t&) const;
  ...
  //}
  template <>
  Inline void Pusher<Dimension::TWO_D>::coordinateUpdate(const index_t& p, const vec_t<Dimension::THREE_D>& v) const {
    coordinateUpdate_x123(p, v[0], v[1], v[2]);
  }
  //template <>
  //Inline void Pusher<Dimension::THREE_D>::velocityUpdate(const index_t& p, const vec_t<Dimension::THREE_D>& v) const {
  //  velocityUpdate_v123(p, v[0], v[1], v[2]);
  ...
  template <Dimension D>
  Inline void Pusher<D>::coordinateUpdate_x123(const index_t& p, const real_t& vx1, const real_t& vx2, const real_t& vx3) const {
    // get coordinate & velocity
    coord_t<D> xp;
    getParticleCoordinate(p, xp);
    vec_t<Dimension::THREE_D> v {vx1, vx2, vx3};
