...
namespace ntt {
  ...
  void GRPIC<Dimension::TWO_D>::fieldBoundaryConditions(const real_t& t, const short& s) {
    ...
    Kokkos::parallel_for(
      ...
      Lambda(index_t i, index_t j) {
        ...
        // mblock.em0(i, j, em::bx3) = mblock.em0(i + 1, j, em::bx3);
        ...
        // mblock.em(i, j, em::bx3) = mblock.em(i + 1, j, em::bx3);
  ...
  template <>
  void GRPIC<Dimension::THREE_D>::AuxiliaryBoundaryConditions(const real_t&, const short& s) {
    NTTError("not implemented");
  }
