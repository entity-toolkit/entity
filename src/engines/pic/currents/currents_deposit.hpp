...
namespace ntt {
  ...
  // 1D
  template <>
  Inline auto DepositCurrents_kernel<Dim1>::getDepositInterval(
    index_t&            p,
    vec_t<Dim3>&        vp,
    ...
    coord_t<Dim1>&      xp_f,
    coord_t<Dim1>&      xp_i,
    coord_t<Dim1>&      xp_r) const -> void {
    Ip_f[0] = m_particles.i1(p);
    xp_f[0] = static_cast<real_t>(Ip_f[0]) +
              static_cast<real_t>(m_particles.dx1(p));
    ...
    xp_r[0] = math::fmin(
      static_cast<real_t>(math::fmin(Ip_i[0], Ip_f[0]) + 1),
  ...
  // 2D
  template <>
  Inline auto DepositCurrents_kernel<Dim2>::getDepositInterval(
    index_t&            p,
    vec_t<Dim3>&        vp,
    ...
    coord_t<Dim2>&      xp_f,
    coord_t<Dim2>&      xp_i,
    coord_t<Dim2>&      xp_r) const -> void {
    Ip_f[0] = m_particles.i1(p);
    Ip_f[1] = m_particles.i2(p);

    xp_f[0] = static_cast<real_t>(Ip_f[0]) +
              static_cast<real_t>(m_particles.dx1(p));
    xp_f[1] = static_cast<real_t>(Ip_f[1]) +
              static_cast<real_t>(m_particles.dx2(p));
  ...
  Inline auto DepositCurrents_kernel<Dim2>::getDepositInterval(
    ...
    xp_r[1] = math::fmin(
      static_cast<real_t>(math::fmin(Ip_i[1], Ip_f[1]) + 1),
  ...
  // 3D
  template <>
  Inline auto DepositCurrents_kernel<Dim3>::getDepositInterval(
    index_t&            p,
    vec_t<Dim3>&        vp,
    ...
    xp_f[1] = static_cast<real_t>(Ip_f[1]) +
              static_cast<real_t>(m_particles.dx2(p));
    xp_f[2] = static_cast<real_t>(Ip_f[2]) +
              static_cast<real_t>(m_particles.dx3(p));
