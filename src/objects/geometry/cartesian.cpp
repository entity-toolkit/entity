...
Inline auto CartesianSystem<D>::convert_x1TOx(const real_t& x1) const -> real_t { return x1; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_x1x2TOxy(const real_t& x1, const real_t& x2) const -> std::tuple<real_t, real_t> { return {x1, x2}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_x1x2x3TOxyz(const real_t& x1, const real_t& x2, const real_t& x3) const -> std::tuple<real_t, real_t, real_t> { return {x1, x2, x3}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_xTOx1(const real_t& x) const -> real_t {return x; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_xyTOx1x2(const real_t& x, const real_t& y) const -> std::tuple<real_t, real_t> { return {x, y}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_xyzTOx1x2x3(const real_t& x, const real_t& y, const real_t& z) const -> std::tuple<real_t, real_t, real_t> { return {x, y, z}; }

// velocity conversion
template<Dimension D>
Inline auto CartesianSystem<D>::convert_ux1TOux(const real_t& ux1) const -> real_t { return ux1; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_ux1ux2TOuxuy(const real_t& ux1, const real_t& ux2) const -> std::tuple<real_t, real_t> { return {ux1, ux2}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_ux1ux2ux3TOuxuyuz(const real_t& ux1, const real_t& ux2, const real_t& ux3) const -> std::tuple<real_t, real_t, real_t> { return {ux1, ux2, ux3}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_uxTOux1(const real_t& ux) const -> real_t { return ux; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_uxuyTOux1ux2(const real_t& ux, const real_t& uy) const -> std::tuple<real_t, real_t> { return {ux, uy}; }

template<Dimension D>
Inline auto CartesianSystem<D>::convert_uxuyuzTOux1ux2ux3(const real_t& ux, const real_t& uy, const real_t& uz) const -> std::tuple<real_t, real_t, real_t> { return {ux, uy, uz}; }
