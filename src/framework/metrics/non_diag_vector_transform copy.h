 ...
 */
  ...
  Inline void 
  v_Hat2Cntrv(const coord_t<D>& xi, const vec_t<Dimension::THREE_D>& vi_hat, vec_t<Dimension::THREE_D>& vi) const {
...
Inline void 
v_Cntrv2Hat(const coord_t<D>& xi, const vec_t<Dimension::THREE_D>& vi, vec_t<Dimension::THREE_D>& vi_hat) const {
...
Inline void
v_Cov2Hat(const coord_t<D>& xi, const vec_t<Dimension::THREE_D>& vi, vec_t<Dimension::THREE_D>& v_hat) const {
    real_t A0 {std::sqrt(h_33(xi) / ( h_11(xi) * h_33(xi) - h_13(xi) * h_13(xi)))};
