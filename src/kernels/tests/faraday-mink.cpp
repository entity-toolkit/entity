...
void testFaraday(const std::vector<unsigned int>&);

template <>
void testFaraday<Dim::_1D>(const std::vector<unsigned int>& res) {
...
template <>
void testFaraday<Dim::_2D>(const std::vector<unsigned int>& res) {
...
template <>
void testFaraday<Dim::_3D>(const std::vector<unsigned int>& res) {
