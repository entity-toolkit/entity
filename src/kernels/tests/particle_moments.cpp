...
void testParticleMoments(const std::vector<std::size_t>&      res,
  ...
  Kokkos::parallel_for("ParticleMoments",
                       10,
                       ParticleMoments_kernel<S, M, FldsID::T>(comp1,
                                                               scatter_buff,
                                                               0,
                                                               i1,
                                                               i2,
  ...
  Kokkos::parallel_for("ParticleMoments",
                       10,
                       ParticleMoments_kernel<S, M, FldsID::T>(comp2,
                                                               scatter_buff,
                                                               1,
                                                               i1,
                                                               i2,
  ...
  Kokkos::parallel_for("ParticleMoments",
                       10,
                       ParticleMoments_kernel<S, M, FldsID::T>(comp3,
                                                               scatter_buff,
                                                               2,
                                                               i1,
                                                               i2,
