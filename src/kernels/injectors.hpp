    ...
    Inline void operator()(index_t p) const {
      ...
      { // generate the velocity
        ...
        if constexpr (M::CoordType == Coord::Cart) {
          ...
          energy_dist(x_Cd, v_Ph, spidx1);
          metric.template transform_xyz<Idx::T, Idx::XYZ>(x_Cd, v_Ph, v1);
          energy_dist(x_Cd, v_Ph, spidx2);
          metric.template transform_xyz<Idx::T, Idx::XYZ>(x_Cd, v_Ph, v2);
