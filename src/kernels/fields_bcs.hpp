    ...
    Inline void operator()(index_t i1, index_t i2) const {
      if constexpr (M::Dim == Dim::_2D) {
        ...
        if constexpr (S == SimEngine::SRPIC) {
          ...
          if (tags & BC::B)
          {
            Fld((N_GHOSTS)-i1, i2, em::bx1) =  - Fld(N_GHOSTS+1+i1, i2, em::bx1);
            Fld((N_GHOSTS)-i1, i2, em::bx2) =  - Fld(N_GHOSTS+1+i1, i2, em::bx2);
            Fld((N_GHOSTS)-i1, i2, em::bx3) =  - Fld(N_GHOSTS+1+i1, i2, em::bx3);
