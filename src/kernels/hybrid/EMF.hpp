...
namespace kernel::hybrid {
  ...
  public:
    ...
    Inline void compute_Ec(tuple_t<ncells_t, D>& i,
                           real_t&               E0,
                           real_t&               E1,
                           real_t&               E2) const {
      const real_t coeff_1 { rho0 * gamma_ad * theta };
      ...
      if constexpr (D == Dim::_1D) {
        ...
        E0 = -Bfs(i1, comp_Bfs + 1) * PP(i1, comp_PP + 2) +
                         Bfs(i1, comp_Bfs + 2) * PP(i1, comp_PP + 1);
        E1 = (INV_2 * Bfs(i1 + 1, comp_Bfs + 0) +
                          INV_2 * Bfs(i1, comp_Bfs + 0)) *
                           PP(i1, comp_PP + 2) -
                         Bfs(i1, comp_Bfs + 2) * PP(i1, comp_PP + 0);
        E2 = -(INV_2 * Bfs(i1 + 1, comp_Bfs + 0) +
                           INV_2 * Bfs(i1, comp_Bfs + 0)) *
                           PP(i1, comp_PP + 1) +
                         Bfs(i1, comp_Bfs + 1) * PP(i1, comp_PP + 0);

        E0 += coeff_1 * math::pow(NN(i1, comp_NN), gamma_ad - ONE) *
        ...
        E0 += coeff_1 * math::pow(NN(i1, i2, comp_NN), gamma_ad - ONE) *
                   INV_2 * (NN(i1 + 1, i2, comp_NN) - NN(i1 - 1, i2, comp_NN));
        E1 += coeff_1 * math::pow(NN(i1, i2, comp_NN), gamma_ad - ONE) *
    ...
    Inline void operator()(STEP0, cellidx_t i1, cellidx_t i2) const {
    ...
    Inline void operator()(STEP0, cellidx_t i1, cellidx_t i2,cellidx_t i3) const {
