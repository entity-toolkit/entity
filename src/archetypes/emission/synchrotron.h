/**
 * @file archetypes/emission/synchrotron.h
 * @brief Emission policy for synchrotron
 * @implements
 *   - arch::emission::Synchrotron<>
 * @namespaces:
 *   - arch::emission::
 */

#ifndef ARCHETYPES_EMISSION_SYNCHROTRON_H
#define ARCHETYPES_EMISSION_SYNCHROTRON_H
...
#endif // ARCHETYPES_EMISSION_SYNCHROTRON_H
