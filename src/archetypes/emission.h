...
namespace arch {
  ...
  struct EmissionSynchrotron {
    ...
    EmissionSynchrotron(Particles<M::Dim, M::CoordType>& photon_species,
  ...
  struct EmissionCompton {
    ...
    EmissionCompton(Particles<M::Dim, M::CoordType>& photon_species,
                    spidx_t                          emitted_index,
                    float                            sp_mass,
                    float                            sp_charge,
                    RadiativeDragFlags               radiative_drag_flags,
