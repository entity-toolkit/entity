...
namespace arch {
   ...
   * @note for engines with a lone species (e.g. HYBRID ions), where the
   *       charge-neutral pair injector does not apply
   * @param params Simulation parameters
   * @param domain Domain object
   * @param species Species index (1-based)
  ...
  inline void InjectUniform(const SimulationParams&     params,
...

    {
      ...
      Kokkos::parallel_for("InjectUniform",
                           nparticles,
                           kernel::UniformInjectorSingle_kernel<S, M, ED>(
